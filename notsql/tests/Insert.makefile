...
testInsert: testInsert.o NotsqlInterpreter.o NotsqlExpr.o NotsqlIndexManager.o \
	...
	g++ -o testInsert *.o $(INCPATH)

testInsert.o : testInsert.cpp NotsqlInterpreter.h NotsqlAPI.h
	g++ -c -g testInsert.cpp $(INCPATH)

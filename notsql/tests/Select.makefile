...
testSelect: testSelect.o NotsqlInterpreter.o NotsqlExpr.o \
	...
	g++ -o testSelect *.o $(INCPATH)

testSelect.o : testSelect.cpp NotsqlInterpreter.h NotsqlAPI.h
	g++ -c -g testSelect.cpp $(INCPATH)

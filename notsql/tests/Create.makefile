...
INCPATH = -I$(CURDIR)/../utils/lib -I$(CURDIR)/../Interpreter/lib -I$(CURDIR)/../API/lib \
		  ...
		  -I$(CURDIR)/../CatalogManager/lib -I$(CURDIR)/../BTree/include -Wall

testCreate: testCreate.o NotsqlInterpreter.o NotsqlExpr.o NotsqlIndexManager.o \
	NotsqlBufferManager.o NotsqlBTree.o NotsqlTable.o NotsqlAPI.o\
	NotsqlCatalogDatabase.o NotsqlCatalogManager.o
	g++ -o testCreate *.o $(INCPATH)

testCreate.o : testCreate.cpp NotsqlInterpreter.h NotsqlAPI.h
	g++ -c -g testCreate.cpp $(INCPATH)

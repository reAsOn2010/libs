...
testCreateIndex: testCreateIndex.o NotsqlInterpreter.o NotsqlExpr.o \
	...
	g++ -o testCreateIndex *.o $(INCPATH)

testCreateIndex.o : testCreateIndex.cpp NotsqlInterpreter.h NotsqlAPI.h
	g++ -c -g testCreateIndex.cpp $(INCPATH)
